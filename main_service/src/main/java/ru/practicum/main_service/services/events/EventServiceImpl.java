...
import ru.practicum.main_service.repositories.EventRepository;
import ru.practicum.main_service.repositories.LocationRepository;
import ru.practicum.main_service.repositories.ViewRepository;
...
import ru.practicum.main_service.util.EventStateActionAdmin;
...
public class EventServiceImpl implements EventService {
    ...
    @Override
    public List<EventShortDto> getAllEventsPublic(String text, List<Long> categories, Boolean paid, LocalDateTime rangeStart, LocalDateTime rangeEnd, Boolean onlyAvailable, String sort, Integer from, Integer size, String requestURI, String ip) {
        ...
        statClient.catchHit(requestURI, ip);
        return events.stream()
                .map(this::convertEntityToShortDto)
                .collect(Collectors.toList());
    }
